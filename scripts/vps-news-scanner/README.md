...
2026-09-14부터 경기 일정에 따른 공식 뉴스·RSS 수집과 배경 자료 조회가 추가됐다.
**배포 시 news-scanner.mjs와 match-news.mjs 두 파일을 함께 올려야 한다.**
현재 흐름·상한·재시도·검수 계약은 [인터뷰 뉴스 파이프라인](../../docs/NEWS_INTERVIEW_PIPELINE.md)을 따른다.
아래의 단일 파일·2,800자·수동 발행 설명은 도입 당시 기록이다.
