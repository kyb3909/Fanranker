        ...
        messages: [
          {
            role: "system",
            content:
              '기사 본문을 5줄로 요약한다. 중요: 요약문은 반드시 기사 원문과 동일한 언어로 작성한다(독일어 기사→독일어, 스페인어→스페인어, 영어→영어, 한국어→한국어. 번역 금지). 각 줄은 객관적 사실만, 뉴스 와이어체(평서문). 감상·평가·질문·추측·이모지 금지. JSON 으로만 응답: {"lines": ["...", "...", "...", "...", "..."]}',
          },
