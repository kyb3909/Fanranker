...
import type { DashboardData } from "./_dashboard/data"
...
export default async function AdminControlCenterPage() {
  ...
  return (
    <>
      ...
      >
        <AdminDashboardPanels role={role} data={data} />
      </Suspense>
    </>
  )
}

async function AdminDashboardPanels({
  role,
  data,
}: {
  role: "admin" | "editor"
    ...
    <div className="w-full px-4 pb-6 sm:px-6 2xl:px-8">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        >
          ...
          <p className="text-muted-foreground mb-2 text-xs leading-relaxed">
            ...
            <b>등재</b>를 누르면 그 선수의 소식이 다음 처리 회차에 자동으로 풀립니다. 행에 마우스를
            올리면 근거 기사 제목이 보입니다.
          </p>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-12">
        <div className="xl:col-span-5">
          <TickerModPanel items={d.ticker.recent} canManage={role === "admin"} />
        </div>
