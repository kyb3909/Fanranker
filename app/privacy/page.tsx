    ...
    <main id="main-content" className="mx-auto max-w-2xl px-4 py-5 sm:px-6 sm:py-6" tabIndex={-1}>
      ...
      <Card className="border-border bg-card mt-4 border p-6">
        ...
        <div className="text-foreground/90 space-y-6 text-[14px] leading-relaxed">
          ...
          <p>
            블루버드홀딩스(이하 &quot;회사&quot;)는 개인정보보호법, 정보통신망법 등 관련 법령을 준수하며,
            공놀이판(gongnori.fan) 서비스 이용자의 개인정보를 보호하기 위해 다음과 같은 처리방침을 수립합니다.
          </p>

          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">1. 수집하는 개인정보 항목</h2>
          ...
          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">2. 개인정보의 수집 및 이용 목적</h2>
            <ul className="list-disc space-y-1 pl-5">
              <li><strong>회원 관리:</strong> 가입 의사 확인, 본인 식별, 부정 이용 방지, 고지·안내 사항 전달</li>
              <li><strong>서비스 제공:</strong> 게시판 이용, 승부 예측, 커뮤니티 기능, 콘텐츠 제공</li>
              <li><strong>결제 처리:</strong> 유료 서비스 결제 및 환불 처리</li>
              <li><strong>서비스 개선:</strong> 이용 통계 분석, 서비스 품질 개선, 맞춤형 콘텐츠 제공</li>
              <li><strong>안전한 환경:</strong> 불법·부적절 활동 탐지 및 방지, 분쟁 조정</li>
            </ul>
          </section>

          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">3. 개인정보의 보유 및 이용 기간</h2>
            <p className="mb-2">회사는 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관련 법령에 따라 보존이 필요한 경우 아래 기간 동안 보관합니다.</p>
            <div className="bg-muted/30 rounded-md p-3">
              <ul className="list-disc space-y-1 pl-5">
          ...
          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">4. 개인정보의 제3자 제공</h2>
          ...
          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">5. 개인정보 처리 위탁</h2>
            ...
            <p className="text-muted-foreground mt-2 text-[13px]">
              해외 위탁 업체의 경우, 각 업체의 개인정보 보호정책에 따라 안전하게 관리되며,
              GDPR 등 국제 기준을 준수합니다.
            </p>
          </section>

          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">6. 개인정보의 파기 절차 및 방법</h2>
            <ul className="list-disc space-y-1 pl-5">
              <li><strong>파기 절차:</strong> 보유 기간이 만료되거나 처리 목적이 달성된 개인정보는 별도의 DB로 이동하여 일정 기간 후 파기합니다.</li>
              <li><strong>파기 방법:</strong> 전자적 파일은 복구 불가능한 방법으로 삭제하며, 종이에 출력된 정보는 분쇄하여 파기합니다.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">7. 이용자의 권리와 행사 방법</h2>
            ...
            <p className="mt-2">
              권리 행사는 서비스 내 프로필 설정 또는 아래 연락처를 통해 요청할 수 있으며,
              회사는 지체 없이 조치합니다.
            </p>
          </section>

          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">8. 쿠키의 운용 및 관리</h2>
            <p className="mb-2">
              회사는 로그인 세션 유지 및 서비스 품질 향상을 위해 쿠키를 사용합니다.
              회원은 브라우저 설정을 통해 쿠키를 거부할 수 있으나, 이 경우 일부 서비스 이용이 제한될 수 있습니다.
            </p>
            <div className="bg-muted/30 rounded-md p-3 text-[13px]">
              <p className="mb-1 font-medium">쿠키 설정 방법</p>
              <ul className="list-disc space-y-0.5 pl-5">
                <li><strong>Chrome:</strong> 설정 → 개인 정보 보호 및 보안 → 쿠키</li>
                <li><strong>Safari:</strong> 환경설정 → 개인 정보 보호</li>
                <li><strong>Firefox:</strong> 설정 → 개인 정보 및 보안 → 쿠키</li>
          ...
          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">9. 개인정보의 안전성 확보 조치</h2>
          ...
          <section>
            <h2 className="text-foreground mb-2 text-lg font-semibold">10. 개인정보 보호책임자</h2>
            <div className="bg-muted/30 rounded-md p-3">
            ...
            <p className="mt-2">
              기타 개인정보 침해에 관한 상담은 개인정보침해신고센터(118),
              개인정보분쟁조정위원회(1833-6972)로 문의하실 수 있습니다.
            </p>
          </section>
