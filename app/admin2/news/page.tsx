...
export const metadata: Metadata = { title: "빠른 검수" }
...
export default async function Admin2NewsPage() {
  ...
  // 기존 화면은 50건 제한이라 143건 중 93건은 존재조차 안 보였다 → 전량 조회.
  ...
  return <FastReview items={items} flairs={flairs} />
}
