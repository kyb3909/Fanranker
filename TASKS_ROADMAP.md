...
|------|-------|--------|----------|------|
| 1 | 1.1 | winrstDetl.do 페이지 구조 분석 | 🔴 최우선 | ⬜ 대기 |
| 2 | 1.1 | 결과 크롤링 스크립트 작성 | 🔴 최우선 | ⬜ 대기 |
| 3 | 1.2 | 결과 저장 API | 🔴 최우선 | ⬜ 대기 |
| 4 | 1.3 | JSON 파일 통합 저장 | 🟠 높음 | ⬜ 대기 |
| 5 | 2.1 | 정산 API 구현 | 🔴 최우선 | ⬜ 대기 |
| 6 | 2.2 | 자동 정산 트리거 | 🟠 높음 | ⬜ 대기 |
| 7 | 3.1 | betman_user_sport_stats 테이블 생성 | 🔴 최우선 | ⬜ 대기 |
| 8 | 3.2 | 통계 갱신 로직 | 🔴 최우선 | ⬜ 대기 |
| 9 | 4.1 | 랭킹 조회 API | 🟠 높음 | ⬜ 대기 |
| 10 | 4.2 | 랭킹 UI 업데이트 | 🟠 높음 | ⬜ 대기 |
| 11 | 4.3 | 마이페이지 통계 개선 | 🟡 중간 | ⬜ 대기 |
| 12 | 1.4 | GitHub Actions (결과 수집) | 🟡 중간 | ⬜ 대기 |
| 13 | 3.3 | 통계 재계산 API | 🟡 중간 | ⬜ 대기 |
