 ...
 * - Blockquote/card embeds (X/Twitter, Instagram): lightweight string sanitization
 */
 ...
 *
 * The HTML for these providers is generated by our server from validated data,
 * so we do not need a full DOM sanitizer here. We only strip obviously unsafe
 * constructs that should never appear in our generated markup.
 */
