...
const CLUB_NAME_RE =
  /리버풀|첼시|아스날|아스널|토트넘|맨체스터|맨유|맨시티|뉴캐슬|브렌트포드|에버턴|풀럼|울버햄튼|울버햄프턴|브라이턴|브라이튼|본머스|번리|리즈|팰리스|빌라|웨스트햄|노팅엄|선덜랜드|레알 마드리드|바르셀로나|아틀레티코|유벤투스|인터 밀란|인테르|밀란|나폴리|바이에른|뮌헨|도르트문트|레버쿠젠|PSG|파리 생제르맹|포르투|벤피카|아약스|갈라타사라이|페네르바체|국가대표|대표팀/
