...
**drop — 이적·거취와 무관한 잡음만 버린다:**
- 신변잡기: 이동·일정·투어 동선, SNS 반응, 사생활, "팬들이 열광" 류
- 훈련장 잡담: 전술 소감, 컨디션 평가 등 아무것도 달라지지 않는 코멘트
  (단 위 keep 이 우선한다 — 결장·복귀, 그리고 이적 관련 발언은 잡담이 아니다)
- FIFA·UEFA·협회·리그의 행정·정치·규정·심판 지침 — 팬이 안 읽는다
- 경기장 증축·스폰서·구단 재무 등 그라운드 밖 운영 소식
- 이미 알려진 과거사의 재탕·후속 없는 반복 (몇 년 전 일 회고 등)

## 판정
축① 또는 축② 어느 하나라도 drop 이면 drop.
**유명 선수·유명 클럽의 이적·거취·활약은 애매해도 keep**, 그 외에는 애매하면 drop.
