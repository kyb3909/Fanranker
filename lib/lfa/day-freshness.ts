 ...
 *    DB와 Data Cache 모두 목록 5분·상세 120초로 맞춘다. DB만 짧게 잡아도
 *    바깥 캐시가 오래된 값을 주므로 원본 갱신은 빨라지지 않는다.
 */
export const FRESH_DAY_LIVE_MS = 5 * 60_000
 ...
 *    (5분, 날짜당 1콜)과 상세 Data Cache(120초)의 실제 주기에 맞춘다.
 */
export const FRESH_LIVE_MS = 120_000
