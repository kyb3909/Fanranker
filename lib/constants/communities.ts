...
export const SPORTS_COMMUNITIES: CommunityInfo[] = [
  {
    ...
    metaDescription:
      "K리그, EPL, 라리가, 세리에A, 분데스리가, 챔피언스리그 등 국내외 축구 뉴스, 경기 분석, 이적 소식, 승부예측을 한곳에서. 공놀이 축구 게시판",
    keywords: [
      "축구",
      "EPL",
      "K리그",
  ...
  },
  {
    ...
    metaDescription:
      "KBO 프로야구, MLB 메이저리그 경기 결과, 선수 분석, 순위, 이적 소식과 승부예측. 공놀이 야구 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "NBA, KBL 프로농구 경기 분석, 선수 스탯, 순위, 트레이드 소식과 승부예측. 공놀이 농구 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "V리그 남녀 프로배구 경기 일정, 결과, 선수 분석, 순위와 팬 토론. 공놀이 배구 게시판",
...
export const LIFE_COMMUNITIES: CommunityInfo[] = [
  {
    ...
    metaDescription:
      "PC, 모바일, PS5, 닌텐도 게임 리뷰, 공략, e스포츠 소식과 게이머 커뮤니티. 공놀이 게임 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "최신 영화 리뷰, 박스오피스 순위, 넷플릭스·디즈니+ 추천, 영화 토론과 평점. 공놀이 영화 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "K-POP, 힙합, 인디, 팝 음악 신곡, 앨범 리뷰, 차트, 콘서트 소식과 음악 토론. 공놀이 음악 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "K-POP 아이돌 컴백, 팬캠, 음방, 팬미팅, 콘서트 소식과 덕질 커뮤니티. 공놀이 아이돌 게시판",
  ...
  },
  {
    ...
    metaDescription:
      "일본 애니메이션 신작, 추천, 리뷰, 만화 소식과 오타쿠 커뮤니티. 공놀이 애니 게시판",
  ...
  },
  {
    ...
    metaDescription: "자유로운 주제로 대화하는 잡담, 유머, 일상 이야기 공간. 공놀이 자유 게시판",
