  ...
  return (
    <div className="flex items-center gap-1">
      <Button
        variant="ghost"
        size="sm"
        className={`h-10 gap-0.5 px-2 ${myVote === "up" ? "text-primary" : "text-muted-foreground"}`}
        onClick={() => onVote("up")}
        aria-label="추천"
      >
      ...
      <Button
        variant="ghost"
        size="sm"
        className={`h-10 gap-0.5 px-2 ${myVote === "down" ? "text-destructive" : "text-muted-foreground"}`}
        onClick={() => onVote("down")}
        aria-label="비추천"
      >
      ...
      {depth < maxDepth && (
        <Button
          variant="ghost"
          size="sm"
          className="text-muted-foreground ml-1 h-10 gap-1 px-2"
        ...
        <div className="ml-auto flex items-center gap-0.5">
          {onBlock && (
            <Button
              variant="ghost"
              size="sm"
              className="text-muted-foreground hover:text-destructive h-10 w-10 gap-1"
              onClick={onBlock}
              title="차단하기"
              aria-label="차단하기"
            >
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-muted-foreground h-10 w-10 gap-1"
            onClick={onReport}
            title="신고하기"
            aria-label="신고하기"
          >
