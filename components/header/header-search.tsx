    ...
    >
      <div className="relative">
        ...
        <input
          ...
          className="text-foreground focus:ring-primary/30 h-10 w-full rounded-full border border-transparent bg-[#f7f6f3] pr-4 pl-9 text-[14px] placeholder:text-[#999999] focus:border-[#e8e5e0] focus:ring-2 focus:outline-none"
        />
        {searchLoading && (
