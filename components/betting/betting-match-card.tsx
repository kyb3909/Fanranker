...
export function BettingMatchCard({
  ...
  return (
    <div className={cn("wc-mrow", hasSelectionFromThisMatch && "selected")}>
      ...
      {/* 선발 라인업은 검증 기간 동안 미공개 페이지(/lineup-preview)에서만 노출한다
          (2026-08-16 운영자: "바로 덮어씌우지 말고 미공개로 하나 페이지를").
          카드 배선 복원 시: <MatchLineup gameId={games[0].id} matchTime={matchTime} compact /> */}
